...
public class JsonUtil {
  ...
  public static Iterator<JsonNode> parser(final InputStream stream) throws Exception {
    try {
      JsonParser parser = FACTORY.createParser(stream);
      parser.setCodec(new ObjectMapper());
      return parser.readValuesAs(JsonNode.class);
    } catch (IOException e) {
      throw new Exception("Cannot read from stream", e);
    }
  }
  ...
  public static <T> T parse(String json, Class<T> returnType) throws Exception {
    ...
    try {
      ...
      throw new Exception("Cannot initialize JSON parser", e);
    }
  }

  public static JsonNode parse(File file) throws Exception {
    return parse(file, JsonNode.class);
  }

  public static <T> T parse(File file, Class<T> returnType) throws Exception {
    ObjectMapper mapper = new ObjectMapper();
    try {
  ...
  public static JsonNode parse(InputStream in) throws Exception {
    return parse(in, JsonNode.class);
  }

  public static <T> T parse(InputStream in, Class<T> returnType) throws Exception {
    ObjectMapper mapper = new ObjectMapper();
    try {
