package com.tongwei.hbase.parser;
...
public class AvroEventParser implements EventParser {
    ...
    private final Map<String, Object> EMPTY_MAP = Collections.emptyMap();
    ...
    @Override
    public Map<String, Object> parseKey(SinkRecord sr) throws EventParsingException {
        return parse(sr.keySchema(), sr.key());
    }

    @Override
    public Map<String, Object> parseValue(SinkRecord sr) throws EventParsingException {
     ...
     * @return
     */
    private Map<String, Object> parse(final Schema schema, final Object value) {
        ...
        try {
            ...
            for (Field field : fields) {
                final Object fieldValue = toValue(record, field);
                if (fieldValue == null) {
                    continue;
                }
    ...
    private Object toValue(final GenericRecord record, final Field field) {
