...
public class HBaseSinkTask extends SinkTask {
    ...
    public void start(Map<String, String> props) {
        ...
        configuration.set(HConstants.HBASE_DIR, "/hbase");
        configuration.set(HConstants.CLUSTER_DISTRIBUTED, "true");
    ...
    public void put(Collection<SinkRecord> records) {
        ...
        byTable.entrySet().parallelStream().forEach(entry -> {
            hBaseClient.write(sinkConfig.getHbaseTableNameByTopic(entry.getKey()), entry.getValue());
        });
    }
