...
public class HBaseSinkConfig extends AbstractConfig {
    ...
    public static String DEFAULT_HBASE_COLUMN_FAMILY = "cf";
    ...
    public static final String TABLE_NAME_TEMPLATE = "hbase.%s.table";
    ...
    public void validate() {
        final String topicsAsStr = properties.get("topics");
    ...
    /**
     * 
     * @Title: getHbaseTableNameByTopic   
     * @Description: 指定habse table name，不指定默认为topic name
     * @param: @param topic
     * @param: @return
     * @return:String
     */
    public String getHbaseTableNameByTopic(String topic){
		return properties.getOrDefault(String.format(TABLE_NAME_TEMPLATE, topic), topic);
    }
}
