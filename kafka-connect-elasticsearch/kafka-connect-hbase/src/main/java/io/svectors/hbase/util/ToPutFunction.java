...
public class ToPutFunction implements Function<SinkRecord, Put> {
    ...
    public Put apply(final SinkRecord sinkRecord) {
        ...
        final String columnFamily = columnFamily(topicName);
        final String delimiter = rowkeyDelimiter(topicName);
        ...
        final String[] rowkeyColumns = rowkeyColumns(topicName);
     ...
     * @return
     */
    private String[] rowkeyColumns(final String topic) {
        final String entry = String.format(HBaseSinkConfig.TABLE_ROWKEY_COLUMNS_TEMPLATE, topic);
     ...
     * @return
     */
    private String rowkeyDelimiter(final String topic) {
        final String entry = String.format(HBaseSinkConfig.TABLE_ROWKEY_DELIMITER_TEMPLATE, topic);
     ...
     * @return
     */
    private String columnFamily(final String topic) {
        final String entry = String.format(HBaseSinkConfig.TABLE_COLUMN_FAMILY_TEMPLATE, topic);
